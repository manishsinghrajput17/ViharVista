...
//   if (loading) {
//     return <div className="destination-details">Loading...</div>;
//   }
...
//       return;
//     }
//     favorite ? removeFavorite(destination.id) : addFavorite(destination);
//   };

//   const handleOfficialLink = () => {
//     if (destination.official_link) {
//       window.open(destination.official_link, "_blank");
//     }
//   };
...
//           <div className="info-header">
//             <div className="title-wrapper">
//               <h1 className="title-text">{destination.name}</h1>
//               <span className="category-badge">{destination.category}</span>
//             </div>
//             {user && (
//               <button className="favorite-icon" onClick={handleFavoriteClick}>
//                 {favorite ? <Heart color="red" size={20} /> : <Heart size={20} />}
//               </button>
//             )}
//           </div>

//           <div className="detail-grid">
//             <div className="detail-card accent-purple">
//               <MapPin size={20} />
//               <p>{destination.location}</p>
//             </div>
//             <div className="detail-card accent-yellow">
//               <Star size={20} />
...
//             </div>
//             <div className="detail-card accent-green">
//               <Ticket size={20} />
//               <p>{destination.entry_fee}</p>
//             </div>
//           </div>

//           <h2 className="section-heading">About the Destination</h2>
...
//   const favorite = destination ? isFavorite(destination.id) : false;
//   const [mainImage, setMainImage] = useState(destination?.images?.[0] || "");
...
//           <div className="button-row">
//             <a
//               href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(destination.location)}`}
//               target="_blank"
//               rel="noopener noreferrer"
//               className="action-button direction-button"
//             >
