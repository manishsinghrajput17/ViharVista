// src/Admin/AddDestinationPage.jsx
...
import styles from "./AddDestinationPage.module.css";
...
const schema = yup.object().shape({
  ...
  official_link: yup
    ...
    .required("Official link is required"),
  images: yup
    .string()
    .required("At least one image URL is required")
    .test(
      "is-url-list",
      "Must be comma-separated URLs starting with http",
      (value) =>
...
const AddDestinationPage = () => {
  ...
  const onSubmit = async (data) => {
    const newDestination = {
      ...data,
      images: data.images.split(",").map((url) => url.trim()), // proper text[] format
    };
    ...
    if (error) {
      ...
      Swal.fire({
        ...
        text: "New destination has been added.",
    ...
    <div className={styles.container}>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className={styles.form}>
        ...
        <div className={styles.buttonGroup}>
          <button type="submit" className={styles.addBtn}>Add Destination</button>
        </div>
      </form>
    </div>
  );
